...
import hse.sheduleteachers.Calendar.selection.NoneSelectionManager;
import hse.sheduleteachers.Calendar.FetchMonthsAsyncTask;
import hse.sheduleteachers.Calendar.adapter.MonthAdapter;
import hse.sheduleteachers.Calendar.listeners.OnMonthChangeListener;
...
import hse.sheduleteachers.Calendar.selection.RangeSelectionManager;
import hse.sheduleteachers.Calendar.selection.SingleSelectionManager;
import hse.sheduleteachers.Calendar.selection.selectionbar.MultipleSelectionBarAdapter;
import hse.sheduleteachers.Calendar.settings.appearance.AppearanceInterface;
import hse.sheduleteachers.Calendar.settings.date.DateInterface;
import hse.sheduleteachers.Calendar.settings.lists.CalendarListsInterface;
...
import hse.sheduleteachers.Calendar.settings.selection.SelectionInterface;
import hse.sheduleteachers.Calendar.utils.CalendarUtils;
import hse.sheduleteachers.Calendar.utils.SelectionType;
import hse.sheduleteachers.Calendar.utils.WeekDay;
import hse.sheduleteachers.Calendar.utils.snap.GravitySnapHelper;
import hse.sheduleteachers.Calendar.view.ItemViewType;
import hse.sheduleteachers.Calendar.view.SlowdownRecyclerView;
import hse.sheduleteachers.Calendar.view.customviews.CircleAnimationTextView;
import hse.sheduleteachers.Calendar.view.customviews.SquareTextView;

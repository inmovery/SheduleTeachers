package hse.sheduleteachers.Calendar.settings;

import android.support.v7.widget.LinearLayoutManager;

import hse.sheduleteachers.Calendar.settings.appearance.AppearanceInterface;
import hse.sheduleteachers.Calendar.settings.appearance.AppearanceModel;
import hse.sheduleteachers.Calendar.settings.appearance.ConnectedDayIconPosition;
import hse.sheduleteachers.Calendar.settings.date.DateInterface;
import hse.sheduleteachers.Calendar.settings.date.DateModel;
import hse.sheduleteachers.Calendar.settings.lists.CalendarListsInterface;
import hse.sheduleteachers.Calendar.settings.lists.CalendarListsModel;
...
import hse.sheduleteachers.Calendar.settings.selection.SelectionModel;

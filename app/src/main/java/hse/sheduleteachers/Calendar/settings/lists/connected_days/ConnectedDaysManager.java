package hse.sheduleteachers.Calendar.settings.lists.connected_days;
...
public class ConnectedDaysManager {
    ...
    private List<hse.sheduleteachers.Calendar.settings.lists.connected_days.ConnectedDays> connectedDaysList;
    ...
    public List<hse.sheduleteachers.Calendar.settings.lists.connected_days.ConnectedDays> getConnectedDaysList() {
        return connectedDaysList;
    }

    public void setConnectedDaysList(List<hse.sheduleteachers.Calendar.settings.lists.connected_days.ConnectedDays> connectedDaysList) {
        this.connectedDaysList = connectedDaysList;
    }

    public void addConnectedDays(hse.sheduleteachers.Calendar.settings.lists.connected_days.ConnectedDays connectedDays){
